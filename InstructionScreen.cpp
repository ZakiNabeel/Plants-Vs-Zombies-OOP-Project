...
InstructionScreen::InstructionScreen() : Screen("instructionscreenbackground.png"), backButton("Back", 150, 50, 700 - 75, 500) 
{
    backgroundBox.setSize(sf::Vector2f(800, 300));
    backgroundBox.setPosition(100, 150);
    ...
    instructionsText.setPosition(120, 170);
}
